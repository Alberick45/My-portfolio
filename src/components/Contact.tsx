            ...
            <div className="space-y-4">
              ...
              <div className="panel-workshop p-4.5 rounded-xl border-sky-500/10 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm mt-1">ce-abaiden-amissah8423@st.umat.edu.gh</p>
                  <a href="mailto:ce-abaiden-amissah8423@st.umat.edu.gh" className="text-sky-400 hover:underline text-xs mt-1.5 inline-block font-mono-tech">
                    [MAIL_CLIENT.exe]
                  </a>
                </div>
              </div>
