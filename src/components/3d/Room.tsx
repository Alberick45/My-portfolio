  ...
  return (
    <div className="absolute pointer-events-none select-none" style={{ transformStyle: 'preserve-3d' }}>
      ...
      >
        ...
        {/* Floor Shadow Blobs under future furniture */}
      ...
      {/* ===================================================
          2. CEILING PLANE (Exposed Beams, Cable Tray, Industrial Lamps)
          =================================================== */}
      <div
      ...
      >
        ...
        {/* Exposed Steel Beams every 500px */}
        ...
        {/* Industrial Hanging Lamps (Cone + Glow) */}
        {lampPositionsZ.map((posZ, idx) => (
          <div
            key={`lamp-${idx}`}
      ...
      {/* ===================================================
          3. LEFT WALL PLANE (Corrugated Metal + Pegboard Tools)
          =================================================== */}
      <div
      ...
      >
        ...
        {/* Lower Half: Corrugated Metal / Wainscot (Height 260px) */}
        <div
        ...
        {/* Upper Half: Pegboard Matrix with SVG Tool Silhouettes */}
        <div className="absolute top-8 inset-x-8 h-72 rounded-lg bg-slate-950/60 border border-slate-800 p-4">
          <div className="w-full h-full bg-[radial-gradient(#1e293b_2px,transparent_2px)] [background-size:16px_16px] opacity-60 relative">
            ...
            {/* Inline SVG Tool Silhouettes (Wrench, Pliers, Calipers, Saw) */}
      ...
      {/* ===================================================
          4. RIGHT WALL PLANE (Corrugated Metal + Pegboard Tools)
          =================================================== */}
      <div
        className="absolute bg-[#070a14]"
        style={{
      ...
      >
        ...
        {/* Lower Half: Corrugated Metal / Wainscot */}
        <div
          className="absolute bottom-0 inset-x-0 h-64 bg-slate-900 border-t-2 border-sky-500/30"
          style={{
            backgroundImage: 'repeating-linear-gradient(90deg, #0f172a, #0f172a 16px, #1e293b 16px, #1e293b 18px)',
      ...
      >
        {/* Top Half: Corrugated Industrial Roller Shutter (Rolled Down Part) */}
        <div
          className="w-full h-72 bg-slate-900 border-b-8 border-slate-700 relative flex flex-col justify-around items-center p-4"
          style={{
            backgroundImage: 'repeating-linear-gradient(0deg, #0f172a, #0f172a 14px, #1e293b 14px, #1e293b 16px)',
          }}
        >
          {/* Wall Clock above shutter */}
          <div className="w-14 h-14 rounded-full bg-slate-100 border-4 border-slate-800 shadow-md flex justify-center items-center relative">
            <div className="w-1 h-4 bg-slate-900 absolute top-2 rounded-full" />
            <div className="w-3 h-0.5 bg-slate-900 absolute right-3 rounded-full" />
            <div className="w-1.5 h-1.5 rounded-full bg-amber-500" />
          </div>

          {/* Workshop Sign Board */}
          <div className="bg-slate-950 border-2 border-amber-500/50 rounded-lg px-6 py-2 shadow-lg text-center">
            <div className="font-mono-tech font-bold text-sm text-amber-400 tracking-widest">
              A3PK LABS
            </div>
            <div className="font-mono-tech text-[10px] text-slate-400 tracking-wider">
              BUILD. BREAK. LEARN. REPEAT.
            </div>
          </div>
        </div>

        {/* Bottom Half: Half-Raised Shutter Opening showing Daylight Sky underneath */}
